...
public class FormaOdaberiKolegij extends javax.swing.JDialog {
    ...
    public FormaOdaberiKolegij() {
        ...
        ArrayList <KolegijSmjerOdjel> podaci = Main.db.dohvatiKolegijSmjerOdjele(korisnickoIme);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!Main.formaPrijava.glavnaforma.getjButton1().isEnabled())
       {
         ...
         if(!Main.formaPrijava.glavnaforma.getjButton6().isEnabled())
       {
           Main.formaPrijava.glavnaforma.getjButton6().setEnabled(true);
       }
         
          if(!Main.formaPrijava.glavnaforma.getjButton7().isEnabled())
       {
           Main.formaPrijava.glavnaforma.getjButton7().setEnabled(true);
       }
